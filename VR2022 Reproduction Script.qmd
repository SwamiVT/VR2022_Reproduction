...
This file has all the code for the reproduction and futher testing for Veríssimo et. al. (2022) The chunk below loads the packages used and the data as well.
